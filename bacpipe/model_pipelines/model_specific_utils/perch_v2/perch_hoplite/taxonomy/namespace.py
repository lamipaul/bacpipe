...
class Mapping:
    ...
    def __str__(self):
        return (
            f"Mapping from {self.source_namespace} to {self.target_namespace}."
        )
...
class ClassList:
    ...
    def apply_namespace_mapping(
        ...
        if mapping.source_namespace != self.namespace:
            raise ValueError(
                "mapping source namespace does not match class list's"
            )
    ...
    def get_class_map_matrix(
        ...
        if self.namespace != target_class_list.namespace and mapping is None:
            ...
            self.namespace == target_class_list.namespace
